...
function App(props) {
  ...
  return (
    <div style={{width: window.innerWidth * 1, height: window.innerHeight * 1}} className="App">
      ...
      {startPlayerID && <iframe title="Escape360" src={`http://172.46.3.245:8081/index.html?clientId=${startPlayerID}&gameId=${gameID}`} style={{position: 'absolute', left: 200,  zIndex: 1000, width: window.innerWidth * 0.8, height: window.innerHeight * 0.95, backgroundColor: 'blueviolet' }} />}
